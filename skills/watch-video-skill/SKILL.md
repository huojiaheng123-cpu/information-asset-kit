...
- 遇到 AI 工具、AI 项目、能力变化、行业趋势、工作流或未来机会类视频时，必须额外做“价值迁移判断”：这个能力成熟后什么会变便宜、什么会更值钱、用户原有工作方式会怎样改变、用户可以放大什么、应该减少依赖什么、还能贡献什么。
- 如果用户想把短视频沉淀成学习资产，输出要包含：核心观点、可信度、对用户的直接启发、今天/本周/长期行动，以及可转化成内容、脚本、产品、服务、skill 或项目的资产。
